...
void MicroManager::execute(const SquadOrder & inputOrder)
{
	...
	if (_units.empty() || !(inputOrder.getType() == SquadOrderTypes::Attack || inputOrder.getType() == SquadOrderTypes::Defend || inputOrder.getType() == SquadOrderTypes::WallDefend))
	{
		return;
	}
	...
	if (order.getType() == SquadOrderTypes::Defend || order.getType() == SquadOrderTypes::WallDefend)
	{
	...
	if (order.getType() == SquadOrderTypes::Attack || order.getType() == SquadOrderTypes::Defend || order.getType() == SquadOrderTypes::WallDefend)
	{
